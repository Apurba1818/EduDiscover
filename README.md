...
📂 Project Structure
The codebase is organized into a monorepo containing distinct frontend and backend directories for clear separation of concerns.
EduDiscover/
├── backend/
│   ├── middleware/
│   │   └── auth.js         # Intercepts and verifies JWT for protected routes
│   ├── models/
│   │   ├── College.js      # Mongoose Schema for College data
│   │   ├── Question.js     # Mongoose Schema for Q&A Forum threads
│   │   └── User.js         # Mongoose Schema for User accounts & Saved Items
│   ├── server.js           # Main Express App, Middleware config, & API Routes
...
│   ├── src/
│   │   ├── api/
│   │   │   └── axios.js    # Pre-configured Axios instance with JWT Interceptor
│   │   ├── components/
│   │   │   ├── Footer.jsx
│   │   │   ├── Navbar.jsx
│   │   │   └── ScrollToTop.jsx # Utility to reset scroll position on route changes
│   │   ├── context/
│   │   │   └── AuthContext.jsx # React Context for global User State Management
│   │   ├── pages/
│   │   │   ├── Auth.jsx
│   │   │   ├── CollegeDetail.jsx
│   │   │   ├── Compare.jsx
...
│   │   │   ├── QA.jsx
│   │   │   └── SavedItems.jsx
│   │   ├── App.jsx         # Main App component housing React Router Configuration
